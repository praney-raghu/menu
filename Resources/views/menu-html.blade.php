						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
                                    ...
                                    {!! \Modules\DynamicMenu\Models\Menus::select('menu', $menulist) !!}
										...
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												<li class="control-section accordion-section  open add-page" id="add-page">
													<h3 class="accordion-section-title hndle" tabindex="0"> Custom Menu Item <span class="screen-reader-text">Press return or enter to expand</span></h3>
													<div class="accordion-section-content ">
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																<p id="menu-item-url-wrap">
                                                                <div class="form-group">
																	<label class="howto" for="custom-menu-item-url"> <span>Target:</span>
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="form-group">
																	<label class="howto" for="custom-menu-item-name"> <span>Title:</span>
                                                                        <div class="form-group">
																		<input id="custom-menu-item-name" name="label" type="text" class="regular-text menu-item-textbox " required>
                                                                        </div>
																	</label>
                                                                </div>
																</p>
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="description description-thin">
																		<label for="edit-menu-item-title-{{$m->id}}"> Title
																			<br>
																	...
																	<p class="field-css-classes description description-thin">
																		<label for="edit-menu-item-classes-{{$m->id}}"> Before_html (optional)
																			<br>
																			<input type="text" id="clases_menu_{{$m->id}}" class="widefat code edit-menu-item-classes" name="clases_menu_{{$m->id}}" value="{{$m->before_html}}">
																		</label>
																	</p>

																	<p class="field-css-url description description-wide">
																		<label for="edit-menu-item-url-{{$m->id}}"> Target
																			<br>
																			<input type="text" id="url_menu_{{$m->id}}" class="widefat code edit-menu-item-url" id="url_menu_{{$m->id}}" value="{{$m->target}}">
																		</label>
																	</p>
