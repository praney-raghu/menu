...
<script type="text/javascript" src="{{asset('harimayco-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('harimayco-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('harimayco-menu/menu.js')}}"></script>